...
utilities, as summarized in \tref{time.lib.summary}.
...
\rSec2[time.traits.is_fp]{\tcode{treat_as_floating_point}}
...
\rSec2[time.traits.duration_values]{\tcode{duration_values}}
...
\rSec2[time.traits.is_clock]{Class template \tcode{is_clock}}
